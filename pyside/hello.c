...
__PYX_EXTERN_C char *say_hi(void); /*proto*/
...
char *say_hi(void) {
  ...
  __Pyx_RefNannySetupContext("say_hi", 0);
 ...
 *     return "hello from python!"             # <<<<<<<<<<<<<<
 */
  __pyx_r = ((char *)"hello from python!");
  goto __pyx_L0;
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("say_hi", (void (*)(void))say_hi, "char *(void)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
